...
type Raft struct {
	...
	votedFor        int                 // Candidate that recieved vote in current term (or none)
	currentTerm     int                 // Latest term this server has seen. Initialized to 0
	commitIndex     int                 // Index of highest entry known to be committed
	lastApplied     int                 // Index of highest log entry applies to state machine
...
func Make(peers []*labrpc.ClientEnd, me int,
	...
	DPrintf("[%v] Spinning up raft server", me)
	rf := &Raft{}
	rf.peers = peers
